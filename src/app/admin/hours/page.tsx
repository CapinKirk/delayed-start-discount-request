...
export default function HoursPage(){
  ...
  const tzGroups: Array<{region: 'AMER'|'EMEA'|'APAC'|'GLOBAL', zones: string[]}> = [
    ...
    { region: 'AMER', zones: [
      'America/New_York','America/Chicago','America/Denver','America/Phoenix','America/Los_Angeles','America/Anchorage','America/Adak','America/Sao_Paulo','America/Mexico_City','America/Bogota','America/Lima','America/Toronto','America/Vancouver'
    ] },
    { region: 'EMEA', zones: [
    ...
    { region: 'APAC', zones: [
      'Asia/Tokyo','Asia/Seoul','Asia/Singapore','Asia/Hong_Kong','Asia/Taipei','Asia/Shanghai','Asia/Kolkata','Asia/Bangkok','Asia/Jakarta','Asia/Manila','Asia/Kuala_Lumpur','Australia/Perth','Australia/Adelaide','Australia/Darwin','Australia/Brisbane','Australia/Sydney','Australia/Melbourne','Pacific/Auckland'
    ] },
  ];
